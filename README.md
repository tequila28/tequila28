...
## 🔍 Research Interests
My research focuses on bridging the gap between perception and reasoning through advanced optimization techniques. In particular, I focus on utilizing **Reinforcement Learning** to build sustained generalization learning capabilities for **Large Language Models (LLMs)**.
